<template>
    <div>
        ...
        <div class="pc-lists">
            <am-row v-if="!showerror" class="pc-list" v-for="(item, index) in pList" :key="index + 'p'">
                <am-col :span="10" :offset="1">
                    <am-row>
                        <am-col :span="4">
            ...
            <div v-if="showerror" class="focus-error">
                <img width="100%" height="100%" src="../assets/image/focuserror.jpg">
            </div>
        </div>
